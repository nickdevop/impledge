...
READ THE INPUT
STORE THAT INPUT IN QUESUE DATA STRUCTURE
ITTREARTE AND STORE IN THE SELF DECLARE TRIE DATA STRUCTURE 
ITTREATE AND CHECK FOR PREFX OF THAT PARTICULAR STRING                      
DO FOR ALL THE STRING PRESENT IN THE TRIE DATA STRUCTURE
CREATE A DEQUEUE TO SOTRE FIRST AND SECOND LARGEST 
DEQUEUE IS DOUBLE ENDED SO WE USE THIS AS FIRST AND LAST TO STORE FIRST LARGEST AT FRONT AND SECOND LARGEST IN LAST   
STORE IN STRIN1 AND STRING 2 AND PRINT THE FINAL ANS I.E FIRST AND SECOND LARGEST
